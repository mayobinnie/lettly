...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 20px rgba(0,0,0,0.06);">
  ...
  <tr><td style="padding:40px;">
    ...
    <p style="font-size:15px;color:#555;line-height:1.75;margin:0 0 20px;">You have taken the right step. Lettly keeps your portfolio compliant, your documents organised, and keeps you ahead of UK landlord legislation — in England, Scotland and Wales.</p>
