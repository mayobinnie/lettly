...
export default function RRAComplianceHub({ userId, propertyAddress }) {
  ...
  async function handleSave() {
    if (!userId) return
    setSaving(true)
    const payload = { ...rec, user_id: userId, property_address: propertyAddress || '', item_id: selected, updated_at: new Date().toISOString() }
