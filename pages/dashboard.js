...
function Overview({ portfolio, onAddDocs }) {
  ...
  return (
    <div className="fade-up">
      ...
      {props.length===0 ? (
        <div style={{ textAlign:'center', padding:'40px 20px', background:'var(--surface)', border:'0.5px solid var(--border)', borderRadius:14 }}>
          <div style={{ fontFamily:'var(--display)', fontSize:20, fontWeight:300, color:'var(--text-2)', marginBottom:8 }}>No properties yet</div>
          <div style={{ fontSize:13, color:'var(--text-3)', marginBottom:18 }}>Drop your property documents to get started.</div>
